...
if __name__ == '__main__':
    ...
    for i in tqdm(range(sparse_node_feature.shape[1])):
        ...
        sparse_node_feature.iloc[:, i] = sparse_node_feature.iloc[:, i].where(sparse_node_feature.iloc[:, i].isin(map_label_set), 'other')
    ...
    tmp_uid_cat_feats_mean = np.load(f'{FEATURE_SAVE2FILE_PATH}/uid_cat_feats_mean.npy')
    tmp_uid_cat_feats_std = np.load(f'{FEATURE_SAVE2FILE_PATH}/uid_cat_feats_std.npy')
    ...
    tmp_uid_dense_feats_mean = np.load(f'{FEATURE_SAVE2FILE_PATH}/uid_dense_feats_mean.npy')
    tmp_uid_dense_feats_std = np.load(f'{FEATURE_SAVE2FILE_PATH}/uid_dense_feats_std.npy')
